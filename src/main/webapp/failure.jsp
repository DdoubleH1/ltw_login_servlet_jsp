<%--&lt;%&ndash;wrap this page in a card and center it on the screen. The modal should be displayed when the page loads and should be closed when the user clicks on the close button. --%>
